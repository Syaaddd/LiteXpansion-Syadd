...
public class Converter extends AContainer implements PoweredMachine {
    ...
    protected void registerDefaultRecipes() {
        if (Slimefun.getMinecraftVersion().isAtLeast(MinecraftVersion.MINECRAFT_1_17)) {
            addRecipe(new ItemStack(Material.COPPER_INGOT), new ItemStack(SlimefunItems.COPPER_INGOT.item()));
            addRecipe(new ItemStack(SlimefunItems.COPPER_INGOT.item()), new ItemStack(Material.COPPER_INGOT));
        }
